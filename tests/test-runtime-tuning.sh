...
require_line "$root/99-charcoal-sysctl.conf" "vm.dirty_writeback_centisecs=1000"
...
require_line "$root/99-charcoal-memory.conf" "w! /sys/kernel/mm/transparent_hugepage/khugepaged/max_ptes_none - - - - 409"
